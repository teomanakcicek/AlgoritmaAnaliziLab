   ...
   static void ortaBul(int dizi[])
    {
        ...
        System.out.println("1. Dizi max toplam:"+maxSubSum(dizi1));
            System.out.println();
           ...
           System.out.println("2. Dizi max toplam:"+maxSubSum(dizi2));
        }
        else{
              for (int i = 0; i < dizi.length/2; i++) {
                dizi1.add(dizi[i]);
            ...
            System.out.println("1. DİZİ Max toplam:");
            System.out.println(maxSubSum(dizi1));   //tek boyutlu dızı ıcın
